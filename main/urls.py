...
urlpatterns = [
    ...
    # Англ версия
    path('home/en', views.home_en, name='home/en'),
    path('about/en', views.about_en, name='about/en'),
    path('todolist/en', views.todolist_en, name='todolist/en'),
    path('finance/en', views.finance_en, name='finance/en'),
    path('acc/en', views.acc_en, name='acc/en'),
]
